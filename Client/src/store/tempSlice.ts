...
// >("auth/getUser", async (token, { dispatch, getState }) => {
//   try {
//     const fbUser = auth.currentUser;
//     console.log("The user: ", fbUser);
...
//       apiKey: getState().auth.apiKey,
//       // refreshToken: user.refreshToken,
//     };
//     // const response = await axios.get("/api/auth/user", getConfig(token));
//     return user;
//   } catch (err) {
...
//   loading: false,
//   user: localStorage.getItem("conv_user")
//     ? JSON.parse(localStorage.getItem("conv_user") as string)
//     : null,
//   error: undefined,
// };
...
//         localStorage.removeItem("conv_token");
//         localStorage.removeItem("conv_api_key");
...
//         localStorage.setItem("conv_token", action.payload.token);
//         if (action.payload.apiKey)
//           localStorage.setItem("conv_api_key", action.payload.apiKey);
