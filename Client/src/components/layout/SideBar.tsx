...
const Sidebar = () => {
  return (
    <div>
      ...
      {/* ========== MAIN CONTENT ========== */}
      {/* Sidebar Toggle */}
      <div className="sticky top-[20] inset-x-0 z-20 bg-white border-y px-4 sm:px-6 md:px-8 lg:hidden dark:bg-gray-800 dark:border-gray-700">
        <div className="flex items-center py-4">
          ...
          {/* Breadcrumb */}
          <ol
            className="ms-3 mt-[] flex items-center whitespace-nowrap"
      ...
      >
        ...
        >
          <ul className="space-y-1.5">
            ...
            <li>
              <Link
                className="w-full flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-slate-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-100 dark:text-slate-400 dark:hover:text-slate-300 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                to="/documentation"
              >
                <svg
                  className="flex-shrink-0 w-4 h-4"
